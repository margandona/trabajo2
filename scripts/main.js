// Manejo de los eventos de clic para cada botón del menú
$(document).ready(function() {
    $('#show-products').click(mostrarProductos);
    $('#best-selling-products').click(productosMasVendidos);
    $('#category-income').click(ingresosPorCategoria);
    $('#vip-customers').click(clientesVIP);
    $('#inventory-report').click(reporteInventario);
    $('#show-sales').click(mostrarVentas);
});
